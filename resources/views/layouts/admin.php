...
<div class="admin-container">
    <aside class="admin-sidebar">
        ...
        <nav>
            <ul>
                <li><a href="/admin/dashboard" class="<?= strpos($_SERVER['REQUEST_URI'], '/admin') !== false && !strpos($_SERVER['REQUEST_URI'], '/admin/') ? 'active' : (strpos($_SERVER['REQUEST_URI'], '/admin/dashboard') !== false ? 'active' : '') ?>">
                        <i class="fas fa-tachometer-alt"></i> Дашборд
                    </a></li>
                <li><a href="/admin/manage_pages" class="<?= strpos($_SERVER['REQUEST_URI'], '/admin/manage_pages') !== false ? 'active' : '' ?>">
                        <i class="fas fa-file"></i> Страницы
                    </a></li>
                <li><a href="/admin/manage_posts" class="<?= strpos($_SERVER['REQUEST_URI'], '/admin/manage_posts') !== false ? 'active' : '' ?>">
                        <i class="fas fa-newspaper"></i> Статьи
                    </a></li>
                <li><a href="/admin/upload_media" class="<?= strpos($_SERVER['REQUEST_URI'], '/admin/upload_media') !== false ? 'active' : '' ?>">
